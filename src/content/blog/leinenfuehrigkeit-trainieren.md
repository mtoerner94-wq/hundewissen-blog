...
faqs:
  - question: "Wie lange dauert es, Leinenführigkeit zu trainieren?"
    answer: "Die Dauer hängt von Alter, Rasse und bisherigen Gewohnheiten des Hundes ab. Bei konsequentem Training zeigen sich erste Fortschritte nach 2-4 Wochen. Welpen lernen das Laufen an lockerer Leine oft schneller als erwachsene Hunde mit eingefahrenen Zugmustern. Plane mindestens 6-12 Wochen für eine zuverlässige Leinenführigkeit ein."
  - question: "Welche Leine eignet sich am besten für das Leinentraining?"
    answer: "Für das Leinenführigkeit-Training eignet sich eine 2-3 Meter lange, leichte Führleine aus Nylon oder Leder. Rollleinen sind ungeeignet, da sie permanenten Zug erzeugen und dem Hund keine klare Grenze vermitteln. Eine feste Führleine gibt dir bessere Kontrolle und ermöglicht konsistente Signale."
  - question: "Soll ich ein Geschirr oder Halsband beim Leinentraining verwenden?"
    answer: "Ein gut sitzendes Brustgeschirr ist für das Leinentraining empfehlenswerter als ein Halsband. Es verteilt den Druck gleichmäßig auf den Brustkorb und vermeidet Belastungen an Halswirbelsäule und Kehlkopf. Besonders bei Hunden, die stark ziehen, schützt ein Geschirr vor Verletzungen."
  - question: "Warum zieht mein Hund an der Leine?"
    answer: "Hunde ziehen an der Leine, weil sie schneller laufen als Menschen und interessante Reize in der Umgebung erkunden wollen. Das natürliche Lauftempo eines Hundes liegt bei 4-6 km/h, während Menschen nur 3-4 km/h gehen. Zieht der Hund und kommt dadurch vorwärts, wird das Verhalten unbeabsichtigt belohnt und verstärkt sich."
  - question: "Kann ich Leinenführigkeit auch bei einem älteren Hund trainieren?"
    answer: "Leinenführigkeit lässt sich in jedem Alter trainieren. Bei älteren Hunden mit eingefahrenen Zugmustern dauert es oft länger, da zunächst altes Verhalten abgebaut werden muss. Rechne bei erwachsenen Hunden mit 8-16 Wochen konsequentem Training. Geduld und Konsequenz sind hier besonders wichtig."
  - question: "Was mache ich, wenn mein Hund andere Hunde an der Leine anbellt?"
...
sources:
  ...
  - name: "Tierärztliche Vereinigung für Tierschutz (TVT) -- Merkblatt Hundehaltung"
    url: "https://www.tierschutz-tvt.de/"
  - name: "VDH -- Verband für das Deutsche Hundewesen"
    url: "https://www.vdh.de/"
  - name: "AVSAB -- American Veterinary Society of Animal Behavior: Position Statement on Humane Dog Training"
    url: "https://avsab.org/"
---
...
<div class="stat-label">der Hunde ziehen an der Leine</div>
</div>
<div class="stat-item stat-item--beige">
<div class="stat-number">5-10 Min</div>
<div class="stat-label">Trainingseinheiten pro Spaziergang</div>
</div>
<div class="stat-item stat-item--petrol">
<div class="stat-number">2-4 Wochen</div>
<div class="stat-label">bis zu ersten Erfolgen</div>
</div>
<div class="stat-item">
<div class="stat-number">6-12 Wochen</div>
<div class="stat-label">bis zur zuverlässigen Leinenführigkeit</div>
</div>
</div>
...
<p>Laut der American Veterinary Society of Animal Behavior (AVSAB) ist belohnungsbasiertes Training die effektivste und tierschutzgerechteste Methode. Hunde lernen schneller und nachhaltiger, wenn erwünschtes Verhalten belohnt wird, statt unerwünschtes Verhalten bestraft wird.</p>
</div>
</div>
...
<p>Aversive Hilfsmittel wie Stachelhalsbänder, Würgeketten oder Sprühhalsbänder sind tierschutzwidrig und in vielen Ländern verboten. Sie verursachen Schmerz, Angst und können Aggressionen fördern. Die Bundestierärztekammer lehnt ihren Einsatz ausdrücklich ab.</p>
</div>
</div>
...
<p>Führe ein Markerwort wie "Fein" oder "Ja" ein, das du immer im exakten Moment sagst, wenn die Leine locker wird. So versteht dein Hund präzise, welches Verhalten belohnt wird. Alternativ funktioniert auch ein Clicker als Markersignal.</p>
</div>
</div>
...
<p>Welpen, die von Anfang an mit positiver Verstärkung an die Leine gewöhnt werden, zeigen laut VDH deutlich weniger Leinenprobleme im Erwachsenenalter. Investiere in den ersten Wochen täglich 5-10 Minuten -- es lohnt sich langfristig.</p>
</div>
</div>
...
<p>Wenn dein Hund bei Hundebegegnungen extrem reagiert, andere Hunde oder Menschen gefährdet oder du dich unsicher fühlst, suche einen zertifizierten Hundetrainer oder Verhaltenstherapeuten auf. Leinenaggression kann sich ohne fachkundige Unterstützung verschlimmern.</p>
</div>
</div>
...
<p>Notiere nach jedem Spaziergang kurz, wie das Training gelaufen ist. Wie oft musstest du stehen bleiben? In welchen Situationen zieht dein Hund noch? So erkennst du Fortschritte und kannst gezielt an Schwachstellen arbeiten.</p>
</div>
</div>
...
<div class="checklist-item checklist-item--checked">
<div class="check-icon">✓</div>
<span>Gut sitzendes Brustgeschirr</span>
</div>
<div class="checklist-item checklist-item--checked">
<div class="check-icon">✓</div>
<span>Hochwertige Leckerlis (klein, weich, schnell fressbar)</span>
</div>
<div class="checklist-item checklist-item--checked">
<div class="check-icon">✓</div>
<span>Leckerli-Beutel für schnellen Zugriff</span>
</div>
<div class="checklist-item checklist-item--checked">
<div class="check-icon">✓</div>
<span>Reizarme Trainingsstrecke ausgewählt</span>
</div>
<div class="checklist-item checklist-item--checked">
<div class="check-icon">✓</div>
<span>Markerwort oder Clicker eingeführt</span>
</div>
<div class="checklist-item checklist-item--unchecked">
<div class="check-icon"></div>
<span>Optional: Kopfhalfter (Halti) als Übergangshilfe</span>
</div>
<div class="checklist-item checklist-item--unchecked">
<div class="check-icon"></div>
<span>Optional: Längere Schleppleine für Schnüffelpausen</span>
</div>
</div>
